...
object PressedFormats {
  ...
  implicit lazy val apiTeaserConfigFormat: Format[ApiTeaserConfig] = Format(apiTeaserConfigReads, apiTeaserConfigWrites)
  implicit lazy val apiChannelFormat: Format[ApiChannel] = Format(apiChannelReads, apiChannelWrites)
  implicit lazy val apiStageConfigurationFormat: Format[ApiStageConfiguration] = Format(apiStageConfigurationReads, apiStageConfigurationWrites)
  implicit lazy val apiCommercialConfigurationFormat: Format[ApiCommercialConfiguration] = Format(apiCommercialConfigurationReads, apiCommercialConfigurationWrites)
  implicit lazy val apiThemeConfigurationFormat: Format[ApiThemeConfiguration] = Format(apiThemeConfigurationReads, apiThemeConfigurationWrites)
  implicit lazy val apiHeaderConfigurationFormat: Format[ApiHeaderConfiguration] = Format(apiHeaderConfigurationReads, apiHeaderConfigurationWrites)
  implicit lazy val apiBrandingConfigurationFormat: Format[ApiSponsoringConfiguration] = Format(apiBrandingConfigurationReads, apiBrandingConfigurationWrites)
  implicit lazy val apiMetaRobotsFormat: Format[ApiMetaRobots] = Format(apiMetaRobotsReads, apiMetaRobotsWrites)
  implicit lazy val apiMetaConfigurationFormat: Format[ApiMetaConfiguration] = Format(apiMetaConfigurationReads, apiMetaConfigurationWrites)
  implicit lazy val apiConfigurationFormat: Format[ApiConfiguration] = Format(apiConfigurationReads, apiConfigurationWrites)
  implicit lazy val apiPressedContentFormat: Format[ApiPressedContent] = Format(apiPressedContentReads, apiPressedContentWrites)
  implicit lazy val apiTeaserFormat: Format[ApiTeaser] = Format(apiTeaserReads, apiTeaserWrites)
  implicit lazy val apiStageFormat: Format[ApiStage] = Format(apiStageReads, apiStageWrites)
  implicit lazy val apiPressedSectionFormat: Format[ApiPressedSection] = Format(apiPressedSectionReads, apiPressedSectionWrites
  )
}
